    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('token', models.UUIDField(default=uuid.UUID('cd9e89b1-9cfc-4b67-8f27-0c98fa56a3de'), editable=False)),
                ('salt', django.contrib.postgres.fields.ArrayField(base_field=models.CharField(max_length=500, null=True), size=None)),
            ],
            options={
